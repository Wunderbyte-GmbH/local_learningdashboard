...
$string['geschaeftsabschluesse'] = 'Competency Checks';
...
$string['namepatternsheading'] = 'Activity name patterns';
$string['namepatternsheading_desc'] = 'Configure the activity name patterns used for quiz results and competency checks. Wildcards like % are allowed.';
$string['lzknamepattern'] = 'LZK / quiz name pattern';
$string['lzknamepattern_desc'] = 'Only quiz and H5P result items whose names match this pattern are included. Example: Quiz%';
$string['gpointsnamepattern'] = 'Competency check name pattern';
$string['gpointsnamepattern_desc'] = 'Only assignment items whose names match this pattern are included. Example: Kompetenzcheck%';
$string['pluginname'] = 'Learning Dashboard';
$string['rehacoach'] = 'Reha Coach';
$string['settings'] = 'Learning Dashboard Settings';
$string['showall'] = 'Show All';
$string['showgpoints'] = 'Show Competency Checks (Kompetenzchecks)';
$string['showgpoints_desc'] = 'Display competency checks column in the dashboard tables.';
$string['showlzk'] = 'Show Quiz Results';
$string['showlzk_desc'] = 'Display quiz results column in the dashboard tables.';
$string['showmy'] = 'Show My';
